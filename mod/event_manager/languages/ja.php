<?php 
	...
	$japanese = array(
		...
		'event_manager:menu:events' => '全イベント',
		'event_manager:menu:group_events' => 'グループイベント',
		'event_manager:menu:new_event' => '新規作成',
		...
		'event_manager:sidebar:title' => '表示中...',
		
		'river:comment:object:event' => '%s が「%s」にコメントしました',
		
		'event_manager:list:title' => 'イベント',
		'event_manager:list:searchevents' => 'イベント検索',
		'event_manager:list:advancedsearch' => '詳細検索',
		'event_manager:list:simplesearch' => '簡易検索',
		'event_manager:list:noresults' => 'イベントは見つかりませんでした',
		'event_manager:list:showmorevents' => 'Show more events',
		'event_manager:list:includepastevents' => '終了したイベントも含む',
		'event_manager:list:meattending' => '私が参加するイベント',
		'event_manager:list:owning' => '私が作ったイベント',
		'event_manager:list:friendsattending' => '友達が参加するイベント',
	
		'event_manager:list:navigation:list' => 'リスト',
		'event_manager:list:navigation:all' => '全イベント',
		'event_manager:list:navigation:other' => '他のイベント',
		'event_manager:list:navigation:owned' => '私が作ったイベント',
		'event_manager:list:navigation:your' => '作成したイベント',
		'event_manager:list:navigation:friends' => '友達が作ったイベント',
		'event_manager:list:navigation:attending' => '参加するイベント',
		'event_manager:list:navigation:onthemap' => '地図表示',
		'event_manager:list:navigation:refreshing' => 'イベント更新中',
		...
		'event_manager:edit:title' => 'イベントの追加/編集',
		'event_manager:edit:upload:title' => 'ファイルを追加する',
		'event_manager:edit:form:file' => 'ファイルを選択',
		'event_manager:edit:form:files' => 'ファイル',
		'event_manager:edit:form:venue' => '開催場所',
		'event_manager:edit:form:type' => '種別',
		'event_manager:edit:form:location' => '地図',
		'event_manager:event:edit:maps_address' => '住所',
		'event_manager:edit:form:region' => 'Region',
		'event_manager:edit:form:contact_details' => '連絡先',
		'event_manager:edit:form:website' => 'URL',
		...
		'event_manager:edit:form:fee' => '参加費',
		'event_manager:edit:form:options' => 'オプション',
		'event_manager:edit:form:rsvp_options' => '参加申込オプション',
		'event_manager:edit:form:shortdescription' => '簡単な説明',
		'event_manager:edit:form:organizer' => '主催者',
		'event_manager:edit:form:organizer_rsvp' => '主催者として登録する',
		...
		'event_manager:edit:form:show_attendees' => '参加者を表示しますか?',
		'event_manager:edit:form:notify_onsignup' => 'Notify me when someone signs up',
		'event_manager:edit:form:start_day' => '日付',
		'event_manager:edit:form:start_day:from' => '開始日',
		'event_manager:edit:form:start_day:to' => '終了日',
		'event_manager:edit:form:endregistration_day' => '申込期限',
		'event_manager:edit:form:multiple_days' => 'Multiple days?',
		'event_manager:edit:form:start_time' => '開始時間',
		'event_manager:edit:form:end_time' => '終了時間',
		'event_manager:edit:form:max_attendees' => '定員',
		...
		'event_manager:edit:form:icon' => 'アイコン (変更しない場合は空白)',
		'event_manager:edit:form:registration_completed' => 'イベント登録完了時に表示する文章',
		'event_manager:edit:form:registration_completed:description' => '[NAME]で登録したユーザ名が表示されます。[EVENT]でイベント名が表示されます。',
...
Someone signed off from the '%s' event. You are moved from the waiting list to attending.",	
		...
		'event_manager:event:rsvp' => '参加申込',
		'event_manager:event:editevent' => 'イベント編集',
		'event_manager:event:deleteevent' => 'イベント削除',
		'event_manager:event:uploadfiles' => 'ファイルのアップロード',
		'event_manager:event:attendees' => '参加者',
		'event_manager:event:program' => 'プログラム',
		'event_manager:event:editprogram' => 'プログラム編集',
		...
		'event_manager:event:exportattendees' => '参加者を出力する',
		'event_manager:event:exportwaitinglist' => 'Export waitinglist',
		'event_manager:event:currentavatar' => '現在のアイコン',
		'event_manager:event:editicon' => 'アイコン編集',
		'event_manager:event:preview' => 'プレビュー',
		'event_manager:event:createicon' => '作成',
		'event_manager:event:search_attendees' => '参加者検索',
		...
		// relationships
		'event_manager:event:relationship:event_attending' => '参加する',
		'event_manager:event:relationship:event_attending:entity_menu' => '参加者数 %s',
		'event_manager:event:relationship:event_attending:label' => '参加者',
		...
		'event_manager:event:relationship:event_presenting' => '講師として登録',		
		'event_manager:event:relationship:event_presenting:label' => '講師',		
		'event_manager:event:relationship:event_exhibiting' => '出展する',
		'event_manager:event:relationship:event_exhibiting:label' => '出展者',
		'event_manager:event:relationship:event_organizing' => '主催者として登録',
		...
		// widgets
		'event_manager:widgets:events:title' => 'イベント',
		'event_manager:widgets:events:description' => 'Show upcoming events',
	
		'event_manager:widgets:events:numbertodisplay' => '表示するイベント数',
		'event_manager:widgets:events:showevents' => 'イベントを表示',
		'event_manager:widgets:events:showevents:icreated' => '作成する',
		'event_manager:widgets:events:showevents:attendingto' => '参加する',
	
		// actions
		'event_manager:action:event:edit:ok' => 'イベントを保存しました',
...
If you didn't request to unsubscribe from the event, please disregard this e-mail.",
		...
		// river
		'event_manager:river:event_relationship:create:event_attending' => '%s が「%s」に参加しました',
		...
		'river:create:object:event' => '%s がイベント「%s」を作成しました',
	
		'calculate_route' => 'ルート検索',
